...
import lowRes from './low-res.jpg'
import highRes from './high-res.jpg'
    ...
    <div class="row">
      ...
      <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-12 items-center justify-center flex-col">
            <img class="lg:w-4/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={lowRes}/>
      ...
      <div class="column pt-0">
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-12 items-center justify-center flex-col">
            <img class="lg:w-5/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={highRes}/>
            <div class="text-center lg:w-2/3 w-full">
