...
export default function imageSR(props) {
  return(
    <div class="row">
      ...
      <div class="column shadow-sm rounded-lg mt-10">
      ...
      <div class="column shadow-sm rounded-lg">
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex mt-10 items-center justify-center flex-col">
